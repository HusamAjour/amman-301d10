...
function displayPics(){
  ...
  // When we cahnged rando from var to let it became a block-scoped local variable and its scope is only inside the function displayPics(). Outside of the function (where tha variable was declared using let) has no existance
